...
/**
 * Hilt module providing Retrofit, OkHttp, and FastApiService.
 */
@Module
...
object NetworkModule {
    ...
    fun provideOkHttpClient(): OkHttpClient {
        return OkHttpClient.Builder()
            ...
            .readTimeout(90, TimeUnit.SECONDS)   // AI processing takes time — increased
            .writeTimeout(90, TimeUnit.SECONDS)   // Large base64 uploads — increased
